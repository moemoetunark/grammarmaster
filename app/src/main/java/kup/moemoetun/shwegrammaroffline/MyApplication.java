...
public class MyApplication extends Application
    ...
    private class AppOpenAdManager {
        ...
        private final String AD_UNIT_ID = AppConstant.APP_OPEN;
        ...
        private void loadAd(Context context) {
            // Do not load ad if there is an unused ad or one is already loading, or if ads are disabled.
            if (isLoadingAd || isAdAvailable() || !AppConstant.isAdOn) {
                return;
            }
